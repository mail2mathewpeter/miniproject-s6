...
$result = mysqli_query($conn, "SELECT booking_id,customer_id,caravan_id, start, end, adults,children,amount,place,driver,status FROM booking") or die("database error:". mysqli_error($conn));
$result6= mysqli_query($conn, "SELECT id,customer_id,caravan_id, start, end, adults,children,amount,place,driver,status FROM deletebooking ") or die("database error:". mysqli_error($conn));
