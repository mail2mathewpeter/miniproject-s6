...
$result = mysqli_query($conn, "SELECT id,customer_id,caravan_id, start, end, driver,amount,place,adults,children FROM deletebooking where id='$id'") or die("database error:". mysqli_error($conn));
