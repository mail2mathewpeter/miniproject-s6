                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <form>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"placeholder="Caravan Name" id="txt1" name="caravan_name"value="<?php echo $row['caravan_name'];?>"required>
                                                                        <span id="text1"></span>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="txt2"name="caravan_model" value="<?php echo $row['caravan_model'];?>"required
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="txt3"name="caravan_type" value="<?php echo $row['caravan_type'];?>"required
                                                                        placeholder="Type">
                                                                        <span id="text3"></span>
                                                                    </div>
                                                                </div>
                                                               ...
                                                               <!-- <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"id="inputdate" name="caravan_date"value="<?php echo $row['caravan_redate']; ?>" required readonly>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="txt4" name="txt4"value="<?php echo $row['caravan_regno'];?>"required
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" maxlength="8"class="form-control"id="txt7"name="amount"value="<?php echo $row['amount'];?>"required
                                                                        placeholder="Amount">
                                                                        <span id="text7"></span>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        ...
                                                                        placeholder="file" id="inputfileupload" name="file"accept="image/png,image/gif,image/jpeg" onchange="fileValidation()"value="<?php echo $row['caravan_image'];?>">
                                                                        <span id="text17"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="file" class="form-control" id="inputfileupload2" name="file2"accept="application/pdf" value="<?php echo $row['rc'];?>"onchange="fileValidation2()"
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="file" class="form-control" id="inputfileupload1" name="file1"accept="application/pdf" onchange="fileValidation1()"value="<?php echo $row['caravan_pollution'];?>"
                                                                        placeholder="upload pdf">                                                                     
                                                                           <span id="text16"></span>
                                                                    </div>
                                                                </div>
...
if(isset($_POST["sub"]))
{
   ...
   // $username=$_POST["username"];
    ...
    $query="update caravan set caravan_name='$caravan_name',caravan_model='$model_name',caravan_type='$type',caravan_regno='$caravan_reg',caravan_image='$ifile',caravan_pollution='$pfile',rc='$kfile',amount='$caravan_amount' where id='$id'";
    ...
    if($mathew)
	{
        ...
        <script>
            alert("Successfully updated Caravan Details")
        window.location.href='deletecaravanadmin/editcaravan.php';
            </script>
<?php
    }
