    ...
    <script>
        $(document).ready(function () {
            ...
            $("#txt1").keyup(function () {
                ...
                var letter = /^[A-Za-z ' ']+$/;
                if (n.value == "") {
                    document.getElementById("text1").innerHTML = "<span class='error'>Please enter a valid Employee Name</span>";
                    $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                     mod1=1;
                }
                else if (!n.value.match(letter)) {
                    document.getElementById("text1").innerHTML = "<span class='error'>This is not a valid Employee Name. Please try again</span>";
                    $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                        mod1=1;
                }
...
$('#register').hover(function(){
  ...
  $(this).css("background-color", "#4272d7");
                ...
                $("#txt2").keyup(function () {
                    ...
                    if (n.value == "") {
                        mod2=1;
                        document.getElementById("text2").innerHTML = "<span class='error'>Please enter a  Employee Address</span>";
                        $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                    }
                    else if (!n.value.match(letter)) {
                        mod2=1;
                        document.getElementById("text2").innerHTML = "<span class='error'>This is not a  valid Employee Address. Please try again</span>";
                        $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                    }
                    else if (n.value.match(letter)) {
...
mod4=0;
                ...
                $("#txt6").keyup(function () {
                    ...
                    if (n.value == "") {
                        mod5=1;
                        document.getElementById("text6").innerHTML = "<span class='error'>Please enter a employee year of experience</span>";
                        $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                    }
                    else if (!n.value.match(letter)) {
                        mod5=1;
                        document.getElementById("text6").innerHTML = "<span class='error'>This is not a valid employee year of experience </span>";
                        $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                    }
                    else if (n.value.match(letter)) {
...
mod5=0;
                ...
                $("#txt7").keyup(function () {
                    ...
                    if (n.value == "") {
                        mod6=1;
                        document.getElementById("text7").innerHTML = "<span class='error'>Please enter a  Employee Driving Licence</span>";
                        $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                    }
                    else if (!n.value.match(letter)) {
                        mod6=1;
                        document.getElementById("text7").innerHTML = "<span class='error'>This is not a  valid Employee Driving Licence. Please try again</span>";
                        $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                    }
                    else if (n.value.match(letter)) {
...
mod6=0;
                ...
                $("#register").click(function () {
                    if(mod1==1 ||mod2==1 ||mod3==1 ||mod4==1 ||mod5==1 ||mod6==1|| mod7==1||mod8==1)
{
    $('#register').attr("disabled", true);
    $('#register').css("background","lightblue");
}
                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <form>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"placeholder=" Name" id="txt1" name="employee_name"required>
                                                                        <span id="text1"></span>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="txt2"name="employee_address"required
                                                                        placeholder=" Address">
                                                                        <span id="text2"></span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="txt4" name="employee_mobile" maxlength="10" required
                                                                        placeholder="Mobile">
                                                                        <span id="text4"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="radio"  name="employee_gender"  checked="checked" value="Male"required>&nbsp Male &nbsp&nbsp
                                                                        <input type="radio"  name="employee_gender" value="Female"required>&nbsp Female &nbsp
                                                                        <input type="radio"  name="employee_gender" required>&nbsp Other
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <select name="employee_designation"class="form-control" id="txt5"required>
                                                                        <option value="">--Please choose an option--</option>
                                                                            <option value="Driver">Driver</option>
                                                                            <option value="cleaner">Cleaner</option>
    </select>
                                                                     <!--   <input type="text" class="form-control" id="txt5"name="employee_designation"required
                                                                        placeholder="Designation">
                                                                        <span id="text5"></span>-->
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Employee year of experience</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control" id="txt6"name="employee_year"maxlength="2"required
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Employee Driving Licence </label>
...
if(isset($_POST["sub"]))
{
	...
	$employee_driving=$_POST["employee_driving"];
	//$date=$_POST["employee_join"];
	...
	$query="insert into employee(employee_name,employee_address,employee_email,employee_phone,employee_designation,employee_year,employee_driving,employee_image,employee_status,date,employee_gender,password,code,status)values('$employee_name','$employee_address','$email1','$employee_mobile','$employee_designation','$employee_year','$pfile','$ifile','$id','$date1','$employee_gender','$code','$code','$status')";
    ...
    if($mathew)
	{
        ...
        <script>
            ...
            alert("Successfully Inserted Employee Details")
        window.location.href='employeeregistermail.php';
            </script>
<?php
    }
}
