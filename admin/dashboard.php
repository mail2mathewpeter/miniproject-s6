...
$(document).ready(function() {
    ...
    $('#select').blur(function() {
            email2 = document.getElementById("register1").value;
alert(email2);
            var email1 = $(this).val();
            email1 = document.getElementById("select").value;
            alert(email1);
            if (email1=="none") {
                                            ...
                                            <div class="col-lg-4 col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <font color="green" size="4"> <a href="viewemployee.php">view
                                                                details</font></a><br>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 col-md-12">
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <font color="green" size="4"> <a href="admin.php">view details
                                                        </font></a><br>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            while($data=mysqli_fetch_array($result))
                            {
                              ...
                              ?> <td> <input type="hidden" value="<?php echo  $data['booking_id']?>" id="book"
                                ...
                                ?>
                                 ...
                                 <option value="<?php echo $data3['id']?>">   <?php echo $data3['employee_name']?>    </option>
                                                         ...
                                                         ?>
                                                                            ...
                                                                            if($c=='pending')
                                                                            {
                                                                                ?>
                                                                                    ...
                                                                                    <span
                                                                                        class="label label-warning"><?php echo "<a href='approvebooking.php?id=$data[booking_id]' id='register1'>"?>Pending</span>
                                                                                    <?php
                                                                            } 
