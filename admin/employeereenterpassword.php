...
.body{
	...
	<img src="71.jpg"width="100%"height="500px">
...
$query="update employee set password='$a',status='1' where employee_email='$email'";
  //  $query1="select *from admin where username='$username' && password='$password'";
	...
	<script>
        ...
        window.location.href='/mathew/miniproject-s6/login.php';
		</script>
        <?php
    }
