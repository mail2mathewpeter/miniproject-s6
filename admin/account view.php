...
<br>
                        <input  type="radio" name="gender"disabled=""value="male"<?php if($g=="male"){echo "checked";}?>>Male
                        <input  type="radio" name="gender"disabled=""value="female"<?php if($g=="female"){echo "checked";}?>>Female
                    </div>
                </div>
