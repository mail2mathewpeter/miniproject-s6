                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <form>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Tourist Place
                                                                        Name</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"
                                                                            placeholder="Tourist Place Name" id="txt1"
                                                                            name="add_place" required>
                                                                        <span id="text1"></span>

                                                                    </div>
                                                                </div>
                                                           <!--     <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Opening
                                                                        time</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="time" class="form-control"
                                                                            name="opening_time" required
                                                                            placeholder="Opening time">

                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Closing
                                                                        Time</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="time" class="form-control"
                                                                            name="closing_time" required
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Entry Amount
                                                                    </label>
                                                                    <div class="col-sm-10">
...
-->
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Place
                                                                        image</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="file" class="form-control"
                                                                            placeholder="file" id="inputfileupload"
                                                                            name="file"
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    <div style="margin-left:250px"> <input type="submit"
                                                                            name="sub" class="btn btn-primary btn-round"
...
if(isset($_POST["sub"]))
{
   ...
   // $username=$_POST["username"];
	...
	$query="insert into place(place_name,place_open,place_closetime,place_amount,file,date,status)values('$caravan_name','$model_name','$type','$amount','$ifile','$date','$id')";
...
<script>
alert("Successfully Inserted Tourist Place details");
