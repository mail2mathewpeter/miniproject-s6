...
try {
   ...
   $code=substr(str_shuffle('1234567890QWERTYUIOPASDFGHJKLZXCVBNM'),0,10);
    ...
    $mail->Subject = 'About Deactivation of your account';
    ...
    <div style="margin:50px auto;width:70%;padding:20px 0">
      ...
      <p> We are Deactivating your account due to some anomalies activiy found in your account.If you want to Reactivate your account please sent a mail to our office </p>
