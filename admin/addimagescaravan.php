...
function fileValidation() {
        ...
        function fileValidation2() {
            ...
            if (!allowedExtensions.exec(filePath)) {
                ...
                document.getElementById("text15").innerHTML = "<span class='error'>invalid file type</span>";
                fileInput.value = '';
                $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                return false;
            ...
            {
                document.getElementById("text15").innerHTML = "<span class='error'></span>";
                $('#register').attr("disabled", false);
                        $('#register').css("background","#4272d7");
                        mod6=0;
            }
        ...
        function fileValidation3() {
            ...
            if (!allowedExtensions.exec(filePath)) {
                ...
                document.getElementById("text14").innerHTML = "<span class='error'>invalid file type</span>";
                fileInput.value = '';
                $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                return false;
            ...
            {
                document.getElementById("text14").innerHTML = "<span class='error'></span>";
                $('#register').attr("disabled", false);
                        $('#register').css("background","#4272d7");
                        mod6=0;
            }
        ...
        function fileValidation4() {
            ...
            if (!allowedExtensions.exec(filePath)) {
                ...
                document.getElementById("text13").innerHTML = "<span class='error'>invalid file type</span>";
                fileInput.value = '';
                $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                return false;
            ...
            {
                document.getElementById("text13").innerHTML = "<span class='error'></span>";
                $('#register').attr("disabled", false);
                        $('#register').css("background","#4272d7");
                        mod6=0;
            }
        ...
        function fileValidation5() {
            ...
            if (!allowedExtensions.exec(filePath)) {
                ...
                document.getElementById("text12").innerHTML = "<span class='error'>invalid file type</span>";
                fileInput.value = '';
                $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                return false;
            ...
            {
                document.getElementById("text12").innerHTML = "<span class='error'></span>";
                $('#register').attr("disabled", false);
                        $('#register').css("background","#4272d7");
                        mod6=0;
            }
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="active">
                                            <a href="addimagescaravan.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"><font color="blue">Add images caravan</font>
                                                    </span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Select Caravan</label>
                                                                    <div class="col-sm-10">
                                                                        <select name="caravan"class="form-control" id="txt5"required>
                                                                        <?php
                                          ...
                                          while($data=mysqli_fetch_array($result))
                                          {
                                            ?>
                                                                            ...
                                                                            <option value="<?php echo $data['id']?>"><?php echo $data['caravan_name']?></option>
                                          ...
                                          ?>
                                                               ...
                                                               <!-- <div class="form-group row">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Caravan image1</label>
                                                                    <div class="col-sm-10">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Caravan image2</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="file" class="form-control" id="inputfileupload2" name="file2"accept="image/png,image/gif,image/jpeg"onchange="fileValidation2()"required
                                                                        placeholder="upload pdf">                                                                     
                                                                           <span id="text15"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Caravan image3</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="file" class="form-control" id="inputfileupload1" name="file1"accept="image/png,image/gif,image/jpeg" onchange="fileValidation1()"required
                                                                        placeholder="upload pdf">                                                                     
                                                                           <span id="text16"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Caravan image4</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="file" class="form-control" id="inputfileupload3" name="file3"accept="image/png,image/gif,image/jpeg" onchange="fileValidation3()"required
                                                                        placeholder="upload pdf">                                                                     
                                                                           <span id="text14"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Caravan image5</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="file" class="form-control" id="inputfileupload4" name="file4"accept="image/png,image/gif,image/jpeg" onchange="fileValidation4()"required
                                                                        placeholder="upload pdf">                                                                     
                                                                           <span id="text13"></span>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Caravan image6</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="file" class="form-control" id="inputfileupload5" name="file5"accept="image/png,image/gif,image/jpeg"onchange="fileValidation5()"required
                                                                        placeholder="upload pdf">                                                                     
                                                                           <span id="text12"></span>
                                                                    </div>
                                                                </div>
...
if(isset($_POST["sub"]))
{
   ...
   // $username=$_POST["username"];
    ...
    $jfile=$_FILES["file3"]["name"];
    $qfile=$_FILES["file4"]["name"];
    $rfile=$_FILES["file5"]["name"];
    $date=date("d-m-y");
    $date=date("d-m-y");
    $id='Active';
    $conn=mysqli_connect("localhost","root","","miniprojects6")or die("Connect failed: %s\n". $conn -> error);
	...
	$query="insert into imagescaravan(caravan_id,file1,file2,file3,file4,file5,file6)values('$caravan','$ifile','$pfile','$kfile','$jfile','$qfile','$rfile')";
