    ...
    <script>
        $(document).ready(function () {
            ...
            $("#txt1").keyup(function () {
                ...
                var letter = /^[A-Za-z]+$/;
                if (n.value == "") {
                    document.getElementById("text1").innerHTML = "<span class='error'>Please enter a valid Tourist Place name</span>";
                    $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                     mod1=1;
                }
                else if (!n.value.match(letter)) {
                    document.getElementById("text1").innerHTML = "<span class='error'>This is not a Tourist Place name. Please try again</span>";
                    $('#register').attr("disabled", true);
                        $('#register').css("background","lightblue");
                        mod1=1;
                }
                                        ...
                                        <li class="active">
                                            <a href="editplace1.php">
                                                ...
                                                <span class="pcoded-mtext"
                                                    data-i18n="nav.basic-components.breadcrumbs"><font color="blue">Edit Tourist
                                                    Place</font></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                                        ...
                                                        <div class="card-block">
                                                            ...
                                                            <form>
                                                                <div class="form-group row">
                                                                    <label class="col-sm-2 col-form-label">Tourist Place Name</label>
                                                                    <div class="col-sm-10">
                                                                        <input type="text" class="form-control"placeholder="Tourist Place Name" id="txt1" value="<?php echo $a;?>" name="add_place"required>
                                                                        <span id="text1"></span>
                                                              ...
                                                              <!--  <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="time" class="form-control" name="opening_time"value="<?php echo $b?>"required
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="time" class="form-control" value="<?php echo $c?>" name="closing_time"required
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input type="number" class="form-control"name="amount"value="<?php echo $d?>"required
                                                                        placeholder="Amount">
                                                                    </div>
                                                                </div>-->
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        ...
                                                                        placeholder="file" id="inputfileupload" name="file"accept="image/png,image/gif,image/jpeg" onchange="fileValidation()">
                                                                        <span id="text17"></span>
                                                                    </div>
                                                                </div>
...
{
    $id1=$_GET["id"];
	$caravan_name=$_POST["add_place"];
	$model_name=$_POST["opening_time"];
	$type=$_POST["closing_time"];
	$amount=$_POST["amount"];
    ...
    if($ifile=="")
   {
    ...
    $query="update place set place_name='$caravan_name',place_open='$model_name',place_closetime='$type',place_amount='$amount',file='$ifile' where id='$id1'";
    ...
    if($mathew)
	{
        ...
        <script>
            alert("Successfully Updated Tourist Place Details");
        window.location.href='editplace1.php';
            </script>
<?php
    }
