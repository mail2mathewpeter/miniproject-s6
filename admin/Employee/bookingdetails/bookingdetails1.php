...
<th>More Info</th>
                            ...
                            ?>
                                  ...
                                  <span hidden id="mobile<?php echo $booking['booking_id'] ?>">   <?php echo $data1['phone'] ?></span> 
                                 ...
                                 <span hidden id="place<?php echo $booking['booking_id'] ?>">   <?php echo $booking['place'] ?></span>
                                ...
                                <td> <span  id="end<?php echo $booking['booking_id'] ?>">   <?php echo $a4?></span></td>
                                 ...
                                 <span hidden id="caravantype<?php echo $booking['booking_id']?>">  <?php echo $data['caravan_type']?></span>   
                                  ...
                                  <td>  <span  id="employee<?php echo $booking['booking_id'] ?>">   <?php echo $data5['employee_name'] ?></span>   </td>
