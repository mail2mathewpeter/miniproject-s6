                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input type="text" style="width:300px;" name="file3" class="form-control"
                                id="start" accept="image/png,image/gif,image/jpeg"readonly >
                                </div>
                              <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">End Date</span>
                            <input type="text" style="width:300px;" name="file3" class="form-control"
                                id="end" accept="image/png,image/gif,image/jpeg"readonly
                              >
</div>
<div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Adults</span>
                            <input type="text" style="width:300px;" class="form-control" id="adults" readonly>
