                                                ...
                                                <table class="table" id="myTable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php
                                                                     ...
                                                                     $caravan1="select *from caravan";
                                                                   
                                                                  
                                                                     $i=1;
                                                                     $caravan=mysqli_query($conn,$caravan1);
                                                                     while($cus=mysqli_fetch_array($caravan))
                                                                     {   
                                                                        $custi=$cus['id'];
                                                                     
                                                                        $f=0;
                                                                        $query="select *from booking where driver='$uid'";
                                                                    ...
                                                                    <td><?php echo $i++?></td>
                                                                    <td> <span id="caravanname<?php echo $cus['id'] ?>">   <?php echo $cus['caravan_name'] ?></span> </td>
                                                            
                                 
                                  
                                                            <td> <span hidden id="caravantype<?php echo $cus['id']?>">  <?php echo $cus['caravan_type']?></span>   
                                                             <span hidden id="caravanmodel<?php echo $cus['id']?>">  <?php echo $cus['caravan_model']?></span>
                                                             <span id="caravanregno<?php echo $cus['id'] ?>">   <?php echo $cus['caravan_regno'] ?></span>
                                                           <span  hidden id="amount<?php echo $cus['id'] ?>">   <?php echo $cus['amount'] ?></span>
                                                            
                                                           <td>  <img src="\mathew\miniproject-s6\admin\uploads/<?php echo $cus['caravan_image'];?>"width="68" height="50"alt="Cinque Terre" ></td>
                                                           <td> <a href="\mathew\miniproject-s6\admin\uploads/<?php echo $cus['caravan_pollution'] ?>"target="_blank"><font color="red">View</font></td>
                                                           <td> <a href="\mathew\miniproject-s6\admin\uploads/<?php echo $cus['rc'] ?>"target="_blank"><font color="red">View</font></td>
                                                 <td><button type="button" class="btn btn-success  btn-sm edit" value="<?php echo $cus['id']; ?>"><span class="glyphicon glyphicon-edit"></span> View More</button></td>
                                                                    </td>
