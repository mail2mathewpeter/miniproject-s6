                    ...
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="userbookedcaravan/userbookedcaravan.php">
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h5>Generate feedback user list</h5>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <?php
                                                                     ...
                                                                     $customer1="select *from customer where feedback='0'";
                                                                   
                                                                  
                                                                     $i=1;
                                                                     $customer=mysqli_query($conn,$customer1);
                                                                     ...
                                                                     /*Printing first variable*/
                                                                        if($custi==$a)
                                                                        {
                                                              $query1="select *from login where id='$p'";
                                                                          $result1=mysqli_query($conn,$query1);
                                                                                      $first=$cus['first_name'];
                                                                          $last=$cus['last_name'];
                                                                    ...
                                                                    <td> <img
                                                                            src="/mathew\miniproject-s6\uploads\<?php echo $cus['file'];?>"
                                                                  ...
                                                                  ?>
                                                                    ...
                                                                    <td><?php echo "<a href='feedbackmail.php?id=$cus[id]'class='btn btn-success  btn-sm' >"?><font color="white">Generate Feedback</a></font></td>
