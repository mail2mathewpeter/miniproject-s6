            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Customer Mobile</span>
                            <input type="text" style="width:300px;" class="form-control" id="mobile" readonly>
                        </div>
                   
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Caravan Name:</span>
                            <input type="text" style="width:300px;" name="file1" class="form-control"
                                id="caravanname" accept="image/png,image/gif,image/jpeg"readonly
                              >

                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Caravan Model:</span>
                            <input type="text" style="width:300px;" name="file1" class="form-control"
                                id="caravantype" accept="image/png,image/gif,image/jpeg"readonly
                              >
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Caravan Type:</span>
                            <input type="text" style="width:300px;" name="file2" class="form-control"
                                id="caravanmodel" accept="image/png,image/gif,image/jpeg"readonly
                            >
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Caravan Regno</span>
                            <input type="text" style="width:300px;" name="file3" class="form-control"
                                id="caravanregno" accept="image/png,image/gif,image/jpeg"readonly >
                                </div>
                                <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Start Date</span>
                            <input type="text" style="width:300px;" name="file3" class="form-control"
                                id="start_date" accept="image/png,image/gif,image/jpeg"readonly >
                                </div>
                              <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">End Date</span>
                            <input type="text" style="width:300px;" name="file3" class="form-control"
                                id="end_date1" accept="image/png,image/gif,image/jpeg"readonly
                              >
</div>
<div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Adults</span>
                            <input type="text" style="width:300px;" class="form-control" id="adults_new" readonly>
                    
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Childrens</span>
                            <input type="text" style="width:300px;" class="form-control" id="children" readonly>
                    
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Amount</span>
                            <input type="text" style="width:300px;" name="file4" class="form-control"
                                id="amount" accept="image/png,image/gif,image/jpeg"readonly
                                >

                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Employee Name</span>
                            <input type="text" style="width:300px;" name="file3" class="form-control"
                                id="employee" accept="image/png,image/gif,image/jpeg"readonly
                              >
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Place</span>
                            <input type="text" style="width:300px;" name="file4" class="form-control"
                                id="place" readonly
                                >
