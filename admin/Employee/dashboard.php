...
<script>
  $(document).ready(function() {
    ...
    $('#caravan').change(function() {
            ...
            $.ajax({
                            type:'POST',
                            url:'updatelocationdatabase.php',
                            data:{
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    ...
                                    <li class="">
                                        <a href="\mathew\miniproject-s6\admin\Employee\userbookedcaravan\userbookedcaravan.php">
                                    ...
                                    <li class="">
                                    <a href="bookingdetails/bookingdetails1.php">
                    ...
                    <div class="pcoded-content">
                        ...
                        <?php
                                        ...
                                        $r=0;
                                          ...
                                          $query1="select *from deletebooking where driver='$uid'";
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="k1">
                                                <div class="card-block">
                                                    ...
                                                    <h2 class="text-right"><i class="ti-tag f-left"></i><span><?php echo $s ?></span>
                                                    </h2>
                                                    <p class="m-b-0">This Month<span class="f-right"><?php echo $s ?></span></p>
                                                </div>
                                            </div>
                                            <div class="k2">
                                                <div class="card-block">
                                                    ...
                                                    <h2 class="text-right"><i
                                                            class="ti-reload f-left"></i><span><?php echo $q ?></span></h2>
                                                    <p class="m-b-0">This Month<span class="f-right"><?php echo $q ?></span></p>
                                                </div>
                                            </div>
                                            <div class="k3">
                                                <div class="card-block">
                                                    ...
                                                    <h2 class="text-right"><i
                                                            class="ti-wallet f-left"></i><span><span><?php echo $q ?></span></h2>
                                                    <p class="m-b-0">This Month<span class="f-right"><?php echo $q ?></span></p>
                                                </div>
                                            </div>
                                            <!-- order-card start -->
                            ...
                            while($data=mysqli_fetch_array($result))
                            {
                              ...
                              <span hidden ><?php echo $a5 ?></span>
                                ...
                                <?php
                                    ...
                                    <td> <span  id="customer_name<?php echo $booking['booking_id'] ?>">  <?php echo $data1['first_name']." ".$data1['last_name'] ?></span>   </td>
                                 ...
                                 <span hidden id="adults_new<?php echo $booking['booking_id'] ?>">   <?php echo $booking['adults'] ?></span>
                                 ...
                                 <?php
                                                                    ...
                                                                    <?php   $a5= date("d-m-Y", strtotime($e));?>
                                <td> <span  id="start_date<?php echo $booking['booking_id'] ?>">   <?php echo $a5 ?></span></td>
                                </span></td>
                                                                    <?php  
                                    $d=$booking['end'];
                                     $a4= date("d-m-Y", strtotime($d));?>
                                <td> <span  id="end_date1<?php echo $booking['booking_id'] ?>">   <?php echo $a4?></span></td>
                                  ...
                                  <span  hidden id="amount<?php echo $booking['booking_id'] ?>">   <?php echo $data['amount'] ?></span>
