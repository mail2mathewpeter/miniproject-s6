            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="active">
                                            <a href="Deletecaravan.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"><font color="blue">Delete
                                                    Caravan</font></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                    ...
                    <div class="pcoded-content">
                        ...
                        <td><?php echo "<a href='/mathew\miniproject-s6\admin\deletecaravan1.php?id=$data[id]'class='btn btn-danger  btn-sm edit'>"?><font color="white">change</a></font></td>
                            </tr><tr>
                            <?php
