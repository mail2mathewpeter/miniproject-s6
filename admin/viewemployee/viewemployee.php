                                ...
                                <div class="page-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                           ...
                                           <div style="margin-left:600px;margin-top:-10px;"> <h5>Search:<input type="search" id="myInput" onkeyup="searchTable()" placeholder="Search for names.."><br></div>
                                           <h5>View Employee Details</h5>
                     <div style="margin-left:650px;margin-top:0px"><a href="/mathew\miniproject-s6/generate/employeedetails.php"class="btn btn-orange btn-sm"target=_blank><Font color="blue"size="2">Generate PDF</font></a></div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table" id="myTable">
                                                    <thead>
                                                        ...
                                                        <tr>
                                                            <th>  <font size="2.5">SN</font></th>
                                                            <th><font size="2.5"> Name</font></th>
                                                            <th><font size="2.5">Photo</font></th>
                                                          
                                                            <th><font size="2.5">Designation</font></th>
                                                            <th><font size="2.5"> Licence</font></th>
                                                            <th><font size="2.5">Status</font></th>
                                                            <th><font size="2.5">More Info</font></th>
                                                          
                                                            <th><font size="2.5">Enable/Disable</font></th>
                            ...
                            ?>
                                    ...
                                    <td><?php echo $i++; ?></td>
                            <td><span id="customer_name<?php echo $data['id'] ?>"><?php echo $a?></span></td>
                        <span hidden id="employee_address<?php echo $data['id'] ?>"><?php echo $b?></span></td>
                        <span hidden id="email<?php echo $data['id'] ?>"><?php echo $data['employee_email'] ?></span>
                        <td>  <img src="/mathew\miniproject-s6/admin/Employee/uploads/<?php echo $data['employee_image'];?>"width="68" height="60"alt="Cinque Terre"class="k" >
                       <span hidden id="gender<?php echo $data['id'] ?>"><?php echo $data['employee_gender'] ?></span>
                       <span hidden id="mobile<?php echo $data['id'] ?>"><?php echo $data['employee_phone'] ?></span>
                                </td>
                                <td> <span id="employee_designation<?php echo $data['id'] ?>"><?php echo $data['employee_designation'] ?></span>        
                               
                                <span hidden id="year<?php echo $data['id'] ?>"><?php echo $data['employee_year'] ?></span> 
                                <span hidden id="date<?php echo $data['id'] ?>"><?php echo $data['date'] ?></span> </td>   
                                  </td>
                                  ...
                                  <td><button type="button" class="btn btn-success btn-sm edit" value="<?php echo $data['id']; ?>"><span class="glyphicon glyphicon-edit"></span> View</button></td>
                 

                                  <td><?php echo "<a href='/mathew\miniproject-s6/admin/employeedisable.php?id=$data[id]'class='btn btn-danger btn-sm'>"?><font color="white">Change</a></font></td>
                            </tr><tr>
                            <?php
