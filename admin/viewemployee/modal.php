                    ...
                    <div class="container-fluid">
                        ...
                        <div class="form-group input-group">
                            ...
                            <input type="text" style="width:300px;" name="file1" class="form-control"
                                id="employee_address" accept="image/png,image/gif,image/jpeg"readonly
                              >
                        ...
                        <div class="form-group input-group">
                            ...
                            <input type="text" style="width:300px;" name="file2" class="form-control"
                                id="mobile" accept="image/png,image/gif,image/jpeg"readonly
                            >
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Designation:</span>
                            <input type="text" style="width:300px;" name="file3" class="form-control"
                                id="employee_designation" accept="image/png,image/gif,image/jpeg"readonly
                              >
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;"> Experience:</span>
                            <input type="text" style="width:300px;" name="file3" class="form-control"
                                id="year" accept="image/png,image/gif,image/jpeg"readonly
                              >
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Join Date:</span>
                            <input type="text" style="width:300px;" name="file3" class="form-control"
