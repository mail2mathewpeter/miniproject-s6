                ...
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                            ...
                            $query1="select *from login where status!='2' and code1='1'";
                            ...
                            ?>
                                                                    ...
                                                                    <td><?php echo $i++?></td>
                                                                    <td><span id="customer_name<?php echo $data['id'] ?>"><?php echo  $a." ".$b?></span></td>
                                                                    <td> <img
                                                                            src="/mathew\miniproject-s6\uploads\<?php echo $data['file'];?>"
                                                                            width="68" height="50" alt="Cinque Terre"
                                                                            class="k"></td>
                                                                            <td><span id="phone<?php echo $data['id'] ?>"><?php echo $data['phone'] ?></span></td>
                                                                    <?php
                                                                    while($data1=mysqli_fetch_array($result1))
                            {
                                ?>
                                  <span hidden id="email<?php echo $data['id'] ?>"><?php echo $data1['email'];?></span>
                            ...
                            ?>
                             ...
                             <td><span id="gender<?php echo $data['id'] ?>"><?php echo $data['gender'] ?></span></td>
                                                                 
                             <span hidden id="date<?php echo $data['id'] ?>"><?php echo $data['date'] ?></span>                 
                                                                    <td><?php echo $data1['active']?></td>
                                                                    ...
                                                                    <td><?php echo "<a href='/mathew\miniproject-s6\admin/disableuser.php?id=$data1[id]'class='btn btn-danger  edit'>"?><font color="white">Edit</a></font></td>
