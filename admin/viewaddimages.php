                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="active">
                                            <a href="viewaddimages.php">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert"><font color="blue">Update Images caravan</font></span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
  ...
  <body>
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                            ...
                            $query="select *from imagescaravan";
                        ...
                        $i=1;
                          ...
                          $a=$data['caravan_id'];
                            ?>
                                    ...
                                    <td><?php echo $i++ ?></td>
                                  <?php
                                    $query1="select *from caravan where id='$a'";
                        
                        $result1=mysqli_query($conn,$query1);
                        while($data1=mysqli_fetch_array($result1))
                        {
                            ?>
                                    <td><span id="caravan_name<?php echo $data['caravan_id'] ?>"><?php echo $data1['caravan_name'] ?></span></td>
                                    <td>  <img src="uploads/<?php echo $data['file1'];?>"width="68" height="70"alt="Cinque Terre"class="k" ></td>

                                    <td>  <img src="uploads/<?php echo $data['file2'];?>"width="68" height="70"alt="Cinque Terre"class="k" ></td>
                                   
                                    <td>  <img src="uploads/<?php echo $data['file3'];?>"width="68" height="70"alt="Cinque Terre"class="k" ></td>
                                    <td>  <img src="uploads/<?php echo $data['file4'];?>"width="68" height="70"alt="Cinque Terre"class="k" ></td>
                                    <td>  <img src="uploads/<?php echo $data['file5'];?>"width="68" height="70"alt="Cinque Terre"class="k" ></td>
                                    <td>  <img src="uploads/<?php echo $data['file6'];?>"width="68" height="70"alt="Cinque Terre"class="k" ></td>


                                    <td><button type="button" class="btn btn-success edit" value="<?php echo $data['caravan_id']; ?>"><span class="glyphicon glyphicon-edit"></span> Edit</button></td>
