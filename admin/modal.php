            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Update Image 1:</span>
                            <input type="file" style="width:300px;" name="file1" class="form-control"
                        ...
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Update Image 2:</span>
                            <input type="file" style="width:300px;" name="file2" class="form-control"
                                id="inputfileupload2" accept="image/png,image/gif,image/jpeg"
                            >

                        </div>
                        <div style="margin-left:150px;margin-top:-10px;">
                            <font color="red"><span id="text2"></span>
                                <font>
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;"> Update Image 3:</span>
                            <input type="file" style="width:300px;" name="file3" class="form-control"
                                id="inputfileupload3" accept="image/png,image/gif,image/jpeg"
                              >

                        </div>
                        <div style="margin-left:150px;margin-top:-10px;">
                            <font color="red"><span id="text3"></span>
                                <font>
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Update Image 4:</span>
                            <input type="file" style="width:300px;" name="file4" class="form-control"
                                id="inputfileupload4" accept="image/png,image/gif,image/jpeg"
                                >

                        </div>
                        <div style="margin-left:150px;margin-top:-10px;">
                            <font color="red"><span id="text4"></span>
                                <font>
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Update Image 5:</span>
                            <input type="file" style="width:300px;" name="file5" class="form-control"
                                id="inputfileupload5" accept="image/png,image/gif,image/jpeg"
                                >

                        </div>
                        <div style="margin-left:150px;margin-top:-10px;">
                            <font color="red"><span id="text5"></span>
                                <font>
                        </div>
                        <div class="form-group input-group">
                            <span class="input-group-addon" style="width:150px;">Update Image 6:</span>
                            <input type="file" style="width:300px;" name="file6" class="form-control"
                                id="inputfileupload6" accept="image/png,image/gif,image/jpeg"
                              >
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" value="update" name="sub" id="register" class="btn btn-success"><span
