            ...
            <form class="row" action="" method="POST"enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="phone"maxlength="10" name="phone" value="<?php echo $d?>"required="">
                        <span id="text4"></span>
                    </div>
                </div>
                <div class="col-md-6">
...
if(isset($_POST["sub"]))
{
    ...
    $query ="update customer set first_name='$first_name',last_name='$last_name',gender='$gender', phone='$phone',file='$cfile' where logid='$b'";
    $mathew=mysqli_query($conn,$query);
    $query1="update login set email='$email',password='$password' where id='$b'";
