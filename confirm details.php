    ...
    <header class="">
        <nav class="navbar navbar-expand-lg">
            <div class="container">
              ...
              $email="select *from login where id='$id'";
              $email1=mysqli_query($conn,$email);
		                   		while($email3=mysqli_fetch_array($email1))
				{
                    $email4=$email3['email'];
                }
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <font size="5" color="red">
                                    <div style="margin-left:245px">
                                        <?php echo "<input type='submit'name='check'value='Pay Now' id='rzp-button1' class='btn btn-primary'><div class='filled-button'></div></a>"?>
                                    </div>
                                    <font size="5" color="red">
...
$_SESSION['amount']=$day;
$q="Pending";
	$insert="insert into booking(customer_id,caravan_id,start,end,adults,children,place,status,driver,amount,payment)values('$p','$caravan','$a','$b','$d','$e','$c','$status','pending','$day','$q')";
  $k=mysqli_query($conn,$insert);
  $kid = mysqli_insert_id($conn);
  $_SESSION['book_id']=$kid;

	?>
<script>
window.location.href = '/mathew/miniproject-s6/payment.php';
</script>
