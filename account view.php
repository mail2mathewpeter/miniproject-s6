    ...
    <div class="row">
        <div class="col-lg-4 pb-5">
            ...
            <div class="author-card pb-3">
                <div class="author-card-cover" style="background-image: url(img/6.jpg);"></div>
         ...
         $b= $_SESSION['id'];
             ...
             $query1="select * from login where id='$b'";
            ...
            <div class="wizard">
                ...
                <a class="list-group-item active " href="view account.php">
                    ...
                    <a class="list-group-item" href="#">
                        ...
                        <a class="list-group-item " href="deactivateaccount.php"><i class="fe-icon-map-pin text-muted"></i>Deactivate account</a>
            ...
            <form class="row" action="" method="POST"enctype="multipart/form-data">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="phone" name="phone" value="<?php echo $d?>"required=""disabled>
                        <span id="text4"></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="file"  id="inputfileupload"  name="file" onchange="fileValidation()"value="<?php echo $f?>"title=" dsf" disabled>
...
<br>
                        <input  type="radio"disabled="" name="gender"value="male"<?php if($g=="male"){echo "checked";}?>>Male
                        <input  type="radio" disabled=""name="gender" value="female"<?php if($g=="female"){echo "checked";}?>disabled>Female
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="pass"id="password"value="<?php echo $password?>"disabled>
                        <span id="text5"></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="cpass" id="cpassword"value="<?php echo $password ?>"disabled>
                        <span id="text6"></span>
                    </div>
                </div>
                <div class="col-12">
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        <div class="custom-control custom-checkbox d-block">
                           ...
                           <a href="userloginpage.php"class="btn btn-style-1 btn-primary" >Back</a>
                        </div>
