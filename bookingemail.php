...
try {
   ...
   $code=substr(str_shuffle('1234567890QWERTYUIOPASDFGHJKLZXCVBNM'),0,10);
    ...
    $mail->Subject = 'Booking has been approved';
    ...
    <div style="margin:50px auto;width:70%;padding:20px 0">
      ...
      <p>Thank you for booking Caravan Tourism. We are providing good service for caravan tourism and we always keep in touch with your queries.Other details should be informed later.
