...
<div style="margin-top:-30px;margin-left:800px;">		
							<div class="dropdown">
...
while($row=mysqli_fetch_array($result))
{
				...
				<div style="margin-left:20px">
							<font color="red">caravan Name: </font><font color="green"><?php
							echo $row['caravan_name'];
							?></font><br>
							<font color="red">caravan Model: </font><font color="green"><?php
							echo $row['caravan_model'];
							?></font>
							<br>
							<font color="red">caravan Type: </font><font color="green"><?php
							echo $row['caravan_type'];
							?></font><br>
							<font color="red">caravan Regno: </font><font color="green"><?php
							echo $row['caravan_regno'];
							?></font><br>
							<font color="red">Amount: </font><font color="green"><?php
							echo $row['amount'];
							?></font></div>
                            	<div style="margin-left:100"><font color="red">Book </font><font color="green"></div>
